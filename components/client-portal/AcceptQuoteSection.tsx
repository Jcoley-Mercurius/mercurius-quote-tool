    ...
    return (
      <section className="rounded-2xl border border-mercurius-200 bg-gradient-to-b from-mercurius-50 to-white p-8 shadow-sm text-center">
        ...
        <p className="mt-2 text-sm text-slate-500">
          ...
          will be in touch shortly to schedule your project. Keep this page
          open or save the link for your records.
        </p>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Accept this quote and {businessName} will follow up to schedule your project.
            </p>
          </div>
          <button
            type="button"
            onClick={() => setState({ phase: "signing" })}
            className="shrink-0 inline-flex items-center justify-center gap-2 rounded-xl bg-mercurius-600 px-8 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:bg-mercurius-700 focus:outline-none focus:ring-2 focus:ring-mercurius-500 focus:ring-offset-2"
          >
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 transition-colors focus:border-mercurius-500 focus:outline-none focus:ring-2 focus:ring-mercurius-500/20 disabled:opacity-60 sm:max-w-sm"
          />
        </div>
        ...
        <label className="flex cursor-pointer items-start gap-3">
          ...
          <span className="text-sm leading-relaxed text-slate-600">
            I have reviewed the scope, pricing, and terms of quote{" "}
            <span className="font-mono font-medium">{quoteReference}</span> and
            I agree to move forward. I understand that final pricing may be
        ...
        <div className="flex flex-col gap-3 border-t border-slate-100 pt-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-mercurius-600 px-8 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:bg-mercurius-700 focus:outline-none focus:ring-2 focus:ring-mercurius-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isSubmitting ? (
              <>
